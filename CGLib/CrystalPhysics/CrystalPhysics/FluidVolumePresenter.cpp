...
FluidVolumePresenter::FluidVolumePresenter(FluidVolumeScene* model) :
	model(model),
	view(nullptr)
{
...
void FluidVolumePresenter::createView(SceneShader* sceneShader)
{
	{
...
void FluidVolumePresenter::removeView(SceneShader* sceneShader)
{
...
void FluidVolumePresenter::updateView()
{
	updateScreenView();
	updateParentIdView();
	updateChildIdView();
...
void FluidVolumePresenter::updateScreenView()
{
	PointBuffer pb;
...
void FluidVolumePresenter::updateParentIdView()
{
}

void FluidVolumePresenter::updateChildIdView()
{
}