...
MPSFluidSceneController::MPSFluidSceneController(MPSFluidScene* model) :
	model(model),
	view(nullptr)
{}

void MPSFluidSceneController::createView(SceneShader* sceneShader)
{
	{
...
void MPSFluidSceneController::updateView()
{
