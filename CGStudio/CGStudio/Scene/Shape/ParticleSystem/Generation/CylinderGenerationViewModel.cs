...
namespace PG.CGStudio.Generation.ParticleSystem
{
    public class CylinderGenerationViewModel : BindableBase
    {
        ...
        private void OnGenerate()
        {
            ...
            MainModel.Instance.Repository.AddParticleSystemScene(positions, "PSCylinder", false, 1.0f, new Core.Graphics.ColorRGBA(1.0f, 1.0f, 1.0f, 1.0f));//, Appearance.Value, "PSCylinder");
