...
void ParticleSystem::add(const openvdb::Vec3R& position, const openvdb::Real& radius, const openvdb::Vec3R& v)
{
    Particle pa;
...
openvdb::CoordBBox ParticleSystem::getBBox(const openvdb::GridBase& grid)
{
